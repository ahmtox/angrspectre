...
from pathconfig import setup_paths
setup_paths()
...
from angrspectre.utils.stubs import *  #pylint:disable=unused-wildcard-import
...
def tweetnaclProject():
    proj = angr.Project('testcases/tweetnacl/testbinaryO3')
    makeRandomBytesSecret(proj)
    return proj

def donnaProject():
    return angr.Project('testcases/x25519bench/test')

def opensslProject():
    return angr.Project('testcases/openssl/openssl')
