...
import angrspectre.main as main
from angrspectre.main import angr, funcEntryState, _spectreSimgr
...
def c_donna(args, generating_fname=False):
    ...
    if generating_fname:
        return ''
    proj = angr.Project('testcases/fact-eval/c_donna')
...
def c_ssl3(args, generating_fname=False):
    ...
    if generating_fname:
        return ''
    proj = angr.Project('testcases/fact-eval/c_s3_cbc.O3')
...
def fact_ssl3(args, generating_fname=False):
    ...
    if generating_fname:
        return ''
    proj = angr.Project('testcases/fact-eval/fact_s3_cbc.O3')
...
def c_mee(args, generating_fname=False):
    if generating_fname:
        return ''
    binary = 'testcases/fact-eval/c_mee.O3'
...
def fact_mee(args, generating_fname=False):
    ...
    binary = 'testcases/fact-eval/fact_mee'
...
def c_secretbox(args, generating_fname=False):
    ...
    if generating_fname:
        ...
        return fname
    print(args, flush=True)
    binary = 'testcases/fact-eval/c_secretbox'
    if args.asm:
        binary += '.asm'
    else:
        binary += '.cref'
...
def fact_secretbox(args, generating_fname=False):
    ...
    if generating_fname:
        ...
        return fname
    print(args, flush=True)
    binary = 'testcases/fact-eval/fact_secretbox'
    if args.asm:
        binary += '.asm'
    else:
        binary += '.cref'
